...
public class Table {
    ...
    public String getValueFromCell(int rowNumber, String columnNumber) {
        List<Map<String, WebElement>> rowsWithColumnsByHeading = getRowsWithColumnsByHeadings();
        return rowsWithColumnsByHeading.get(rowNumber - 1).get(columnNumber).getText();
    }
}
